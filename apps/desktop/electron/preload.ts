...
const api: ElectronApi = {
  ...
  parseSubtitles: (filePath) => ipcRenderer.invoke("subtitle:parse-file", filePath),
  saveSubtitles: (filePath, cues) => ipcRenderer.invoke("subtitle:save-file", filePath, cues),
